				...
				case 4:
				    if(escolhaPas == 1){
						...
						System.out.println(" Eticket Excluido.");
							...
							stoPas.excluirEtcket(Integer.parseInt(l.inDados("Digite o cpf do Passageiro para ser excluido o Eticket.:")));
						}
					}
				break;
